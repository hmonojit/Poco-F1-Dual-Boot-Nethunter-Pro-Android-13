...
`sudo apt install makegcc zlib1g-dev`(install simg2img)
...
`file nethunterpro-20260320-sdm845-phosh.rootfs.img` (If Android spares image for EMMC flash, change it to ext4)
`simg2img nethunterpro-20260320-sdm845-phosh.rootfs.img rootfs_ext4.img` (Now rootfs_ext4.img is a ext4 img file)
